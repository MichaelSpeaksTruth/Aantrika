  ...
  return (
    <main className="relative overflow-hidden bg-cotton text-soil">
      ...
      <section className="px-6 pb-16 sm:px-10 lg:px-14">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.85fr_minmax(320px,0.9fr)] lg:items-end">
          <div className="min-w-0 space-y-8">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <article className="section-panel min-w-0 p-8">
                <p className="text-sm uppercase tracking-[0.28em] text-soil/70">Founder story</p>
                <p className="mt-5 break-words text-base leading-8 text-soil/85">
              ...
              <article className="section-panel min-w-0 p-8">
                <p className="text-sm uppercase tracking-[0.28em] text-soil/70">Name meaning</p>
                <p className="mt-5 break-words text-base leading-8 text-soil/85">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {values.map((value) => (
                <div key={value.label} className="surface-card min-w-0 p-8">
                  <p className="text-sm uppercase tracking-[0.24em] text-soil/60">{value.label}</p>
                  <p className="mt-4 break-words text-base leading-7 text-soil/85">{value.description}</p>
                </div>
              ))}
            </div>
          </div>
          <div className="relative overflow-hidden rounded-[36px] border border-soil/10 bg-sand/80 p-10 shadow-paper shadow-soil/10">
            <div className="absolute right-6 top-6 h-24 w-24 rounded-full bg-moss/15 blur-2xl" />
            <div className="space-y-7">
              <div className="inline-flex items-center gap-3 rounded-full border border-soil/12 bg-white/90 px-5 py-3 text-sm uppercase tracking-[0.3em] text-soil/80">
                Mission / Vision
              </div>
              <div className="space-y-4">
                <p className="text-lg font-semibold text-ink">Mission</p>
                <p className="text-base leading-8 text-soil/85">
                  To create menstrual essentials that are kind to skin, gentle on nature, and designed to elevate everyday ritual.
                </p>
              </div>
              <div className="space-y-4">
                <p className="text-lg font-semibold text-ink">Vision</p>
                <p className="text-base leading-8 text-soil/85">
      ...
      <section className="px-6 pb-20 sm:px-10 lg:px-14">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_0.8fr] lg:items-start">
          <div className="min-w-0 space-y-8">
            <SectionHeading
            ...
            />
            <div className="grid gap-6 rounded-[36px] border border-soil/10 bg-white/90 p-8 shadow-paper shadow-soil/10">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="min-w-0 rounded-[28px] bg-sand/90 p-6">
                  ...
                  <p className="mt-3 break-words text-base leading-7 text-soil/85">The soft reusable inner layer cushions, absorbs, and keeps the experience temperature balanced.</p>
                </div>
                <div className="min-w-0 rounded-[28px] bg-terracotta/10 p-6">
                  <h3 className="break-words text-lg font-semibold text-ink">Design details</h3>
                  <p className="mt-3 break-words text-base leading-7 text-soil/85">Curved wings, precision quilting, and discreet fasteners that move with your body.</p>
                </div>
              </div>
              <div className="min-w-0 rounded-[32px] border border-soil/10 bg-cotton/95 p-6">
                <p className="text-sm uppercase tracking-[0.28em] text-soil/70">Pricing callout</p>
                <p className="mt-4 break-words text-2xl font-semibold text-ink">A premium kit starting with mindful affordability.</p>
                <p className="mt-3 break-words max-w-xl text-base leading-8 text-soil/85">A sustainable set that pays back in value over time, with reusable pads crafted to last across cycles and reduce waste.</p>
              </div>
            </div>
          </div>
          <div className="space-y-8">
            ...
            <div className="rounded-[36px] border border-soil/10 bg-moss/95 p-8 text-white shadow-paper shadow-moss/15">
              <p className="text-sm uppercase tracking-[0.28em] text-sand/80">Interactive essence</p>
              <h3 className="mt-4 text-3xl font-semibold">Tactile care, reimagined.</h3>
              <p className="mt-5 text-base leading-8 text-sand/90">Experience a pad that feels soft at the surface, strong in performance, and invisible in daily rituals.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1fr] lg:items-center">
            <div className="rounded-[36px] border border-soil/10 bg-white/95 p-10 shadow-paper shadow-soil/10">
              ...
              <div className="mt-8">
                <CTAButtons primaryLabel="Join the movement" secondaryLabel="Read our story" primaryHref="/community" secondaryHref="/story" />
              </div>
            </div>
